namespace MRLCC_AAAC {
  ...
  FTensorDecl TensorDecls[24] = {
	...
	FEqInfo EqsRes[184] = {
    {"abcd,be,acef,df",           -1.0,   4, { 6,10, 5,19}},     //  -1.0 Ap[abcd] k[be] p[acef] E1[df] 
    {"abcd,be,aecf,df",            2.0,   4, { 6,10, 5,19}},     //   2.0 Ap[abcd] k[be] p[aecf] E1[df] 
    {"abcd,ce,abef,df",            2.0,   4, { 6,10, 5,19}},     //   2.0 Ap[abcd] k[ce] p[abef] E1[df] 
    {"abcd,ce,aebf,df",           -1.0,   4, { 6,10, 5,19}},     //  -1.0 Ap[abcd] k[ce] p[aebf] E1[df] 
    {"abcd,ef,abce,df",           -2.0,   4, { 6,10, 5,19}},     //  -2.0 Ap[abcd] k[ef] p[abce] E1[df] 
    {"abcd,ef,acbe,df",            1.0,   4, { 6,10, 5,19}},     //   1.0 Ap[abcd] k[ef] p[acbe] E1[df] 
    {"abcd,ae,ebcf,df",           -2.0,   4, { 6,11, 5,19}},     //  -2.0 Ap[abcd] k[ae] p[ebcf] E1[df] 
    {"abcd,ae,ecbf,df",            1.0,   4, { 6,11, 5,19}},     //   1.0 Ap[abcd] k[ae] p[ecbf] E1[df] 
    ...
    {"abcd,aehf,fbcg,dg,he",       2.0,   5, { 6,13, 5,19,18}},  //   2.0 Ap[abcd] W[aehf] p[fbcg] E1[dg] delta[he] 
    {"abcd,aehf,fcbg,dg,he",      -1.0,   5, { 6,13, 5,19,18}},  //  -1.0 Ap[abcd] W[aehf] p[fcbg] E1[dg] delta[he] 
    {"abcd,aefh,fbcg,dg,he",      -4.0,   5, { 6,13, 5,19,18}},  //  -4.0 Ap[abcd] W[aefh] p[fbcg] E1[dg] delta[he] 
    {"abcd,aefh,fcbg,dg,he",       2.0,   5, { 6,13, 5,19,18}},  //   2.0 Ap[abcd] W[aefh] p[fcbg] E1[dg] delta[he] 
    ...
    {"abcd,ebfa,ecfg,dg",         -2.0,   4, { 6,15, 5,19}},     //  -2.0 Ap[abcd] W[ebfa] p[ecfg] E1[dg] 
    {"abcd,ebfa,efcg,dg",          1.0,   4, { 6,15, 5,19}},     //   1.0 Ap[abcd] W[ebfa] p[efcg] E1[dg] 
    {"abcd,ebfh,acfg,dg,he",       1.0,   5, { 6,15, 5,19,18}},  //   1.0 Ap[abcd] W[ebfh] p[acfg] E1[dg] delta[he] 
    {"abcd,ebfh,afcg,dg,he",      -2.0,   5, { 6,15, 5,19,18}},  //  -2.0 Ap[abcd] W[ebfh] p[afcg] E1[dg] delta[he] 
    {"abcd,ecfa,ebfg,dg",          4.0,   4, { 6,15, 5,19}},     //   4.0 Ap[abcd] W[ecfa] p[ebfg] E1[dg] 
    {"abcd,ecfa,efbg,dg",         -2.0,   4, { 6,15, 5,19}},     //  -2.0 Ap[abcd] W[ecfa] p[efbg] E1[dg] 
    {"abcd,ecfh,abfg,dg,he",      -2.0,   5, { 6,15, 5,19,18}},  //  -2.0 Ap[abcd] W[ecfh] p[abfg] E1[dg] delta[he] 
    {"abcd,ecfh,afbg,dg,he",       1.0,   5, { 6,15, 5,19,18}},  //   1.0 Ap[abcd] W[ecfh] p[afbg] E1[dg] delta[he] 
    {"abcd,efgh,abcf,dg,he",       2.0,   5, { 6,15, 5,19,18}},  //   2.0 Ap[abcd] W[efgh] p[abcf] E1[dg] delta[he] 
    {"abcd,efgh,acbf,dg,he",      -1.0,   5, { 6,15, 5,19,18}},  //  -1.0 Ap[abcd] W[efgh] p[acbf] E1[dg] delta[he] 
    {"abcd,be,aefg,dfgc",         -1.0,   4, { 6,10, 5,20}},     //  -1.0 Ap[abcd] k[be] p[aefg] E2[dfgc] 
    {"abcd,be,afeg,dfcg",         -1.0,   4, { 6,10, 5,20}},     //  -1.0 Ap[abcd] k[be] p[afeg] E2[dfcg] 
    {"abcd,ce,aefg,dfbg",         -1.0,   4, { 6,10, 5,20}},     //  -1.0 Ap[abcd] k[ce] p[aefg] E2[dfbg] 
    {"abcd,ce,afeg,dfbg",          2.0,   4, { 6,10, 5,20}},     //   2.0 Ap[abcd] k[ce] p[afeg] E2[dfbg] 
    {"abcd,ef,abeg,dfgc",         -1.0,   4, { 6,10, 5,20}},     //  -1.0 Ap[abcd] k[ef] p[abeg] E2[dfgc] 
    {"abcd,ef,abge,dgfc",          1.0,   4, { 6,10, 5,20}},     //   1.0 Ap[abcd] k[ef] p[abge] E2[dgfc] 
    {"abcd,ef,aceg,dfbg",         -1.0,   4, { 6,10, 5,20}},     //  -1.0 Ap[abcd] k[ef] p[aceg] E2[dfbg] 
    {"abcd,ef,acge,dgbf",          1.0,   4, { 6,10, 5,20}},     //   1.0 Ap[abcd] k[ef] p[acge] E2[dgbf] 
    {"abcd,ef,aebg,dfcg",         -1.0,   4, { 6,10, 5,20}},     //  -1.0 Ap[abcd] k[ef] p[aebg] E2[dfcg] 
    {"abcd,ef,aecg,dfbg",          2.0,   4, { 6,10, 5,20}},     //   2.0 Ap[abcd] k[ef] p[aecg] E2[dfbg] 
    {"abcd,ef,agbe,dgcf",          1.0,   4, { 6,10, 5,20}},     //   1.0 Ap[abcd] k[ef] p[agbe] E2[dgcf] 
    {"abcd,ef,agce,dgbf",         -2.0,   4, { 6,10, 5,20}},     //  -2.0 Ap[abcd] k[ef] p[agce] E2[dgbf] 
    {"abcd,ae,ebfg,dfgc",          1.0,   4, { 6,11, 5,20}},     //   1.0 Ap[abcd] k[ae] p[ebfg] E2[dfgc] 
    {"abcd,ae,ecfg,dfbg",          1.0,   4, { 6,11, 5,20}},     //   1.0 Ap[abcd] k[ae] p[ecfg] E2[dfbg] 
    {"abcd,ae,efbg,dfcg",          1.0,   4, { 6,11, 5,20}},     //   1.0 Ap[abcd] k[ae] p[efbg] E2[dfcg] 
    {"abcd,ae,efcg,dfbg",         -2.0,   4, { 6,11, 5,20}},     //  -2.0 Ap[abcd] k[ae] p[efcg] E2[dfbg] 
    ...
    {"abcd,aeif,fbgh,dghc,ie",    -1.0,   5, { 6,13, 5,20,18}},  //  -1.0 Ap[abcd] W[aeif] p[fbgh] E2[dghc] delta[ie] 
    {"abcd,aeif,fcgh,dgbh,ie",    -1.0,   5, { 6,13, 5,20,18}},  //  -1.0 Ap[abcd] W[aeif] p[fcgh] E2[dgbh] delta[ie] 
    {"abcd,aeif,fgbh,dgch,ie",    -1.0,   5, { 6,13, 5,20,18}},  //  -1.0 Ap[abcd] W[aeif] p[fgbh] E2[dgch] delta[ie] 
    {"abcd,aeif,fgch,dgbh,ie",     2.0,   5, { 6,13, 5,20,18}},  //   2.0 Ap[abcd] W[aeif] p[fgch] E2[dgbh] delta[ie] 
    {"abcd,aefi,fbgh,dghc,ie",     2.0,   5, { 6,13, 5,20,18}},  //   2.0 Ap[abcd] W[aefi] p[fbgh] E2[dghc] delta[ie] 
    {"abcd,aefi,fcgh,dgbh,ie",     2.0,   5, { 6,13, 5,20,18}},  //   2.0 Ap[abcd] W[aefi] p[fcgh] E2[dgbh] delta[ie] 
    {"abcd,aefi,fgbh,dgch,ie",     2.0,   5, { 6,13, 5,20,18}},  //   2.0 Ap[abcd] W[aefi] p[fgbh] E2[dgch] delta[ie] 
    {"abcd,aefi,fgch,dgbh,ie",    -4.0,   5, { 6,13, 5,20,18}},  //  -4.0 Ap[abcd] W[aefi] p[fgch] E2[dgbh] delta[ie] 
    ...
    {"abcd,ebfa,ecgh,dghf",        1.0,   4, { 6,15, 5,20}},     //   1.0 Ap[abcd] W[ebfa] p[ecgh] E2[dghf] 
    {"abcd,ebfa,efgh,dgch",        1.0,   4, { 6,15, 5,20}},     //   1.0 Ap[abcd] W[ebfa] p[efgh] E2[dgch] 
    {"abcd,ebfa,egch,dgfh",        1.0,   4, { 6,15, 5,20}},     //   1.0 Ap[abcd] W[ebfa] p[egch] E2[dgfh] 
    {"abcd,ebfa,egfh,dgch",       -2.0,   4, { 6,15, 5,20}},     //  -2.0 Ap[abcd] W[ebfa] p[egfh] E2[dgch] 
    {"abcd,ebfi,afgh,dghc,ie",     1.0,   5, { 6,15, 5,20,18}},  //   1.0 Ap[abcd] W[ebfi] p[afgh] E2[dghc] delta[ie] 
    {"abcd,ebfi,agfh,dgch,ie",     1.0,   5, { 6,15, 5,20,18}},  //   1.0 Ap[abcd] W[ebfi] p[agfh] E2[dgch] delta[ie] 
    {"abcd,ecfa,ebgh,dghf",       -2.0,   4, { 6,15, 5,20}},     //  -2.0 Ap[abcd] W[ecfa] p[ebgh] E2[dghf] 
    {"abcd,ecfa,efgh,dgbh",       -2.0,   4, { 6,15, 5,20}},     //  -2.0 Ap[abcd] W[ecfa] p[efgh] E2[dgbh] 
    {"abcd,ecfa,egbh,dgfh",       -2.0,   4, { 6,15, 5,20}},     //  -2.0 Ap[abcd] W[ecfa] p[egbh] E2[dgfh] 
    {"abcd,ecfa,egfh,dgbh",        4.0,   4, { 6,15, 5,20}},     //   4.0 Ap[abcd] W[ecfa] p[egfh] E2[dgbh] 
    {"abcd,ecfi,afgh,dgbh,ie",     1.0,   5, { 6,15, 5,20,18}},  //   1.0 Ap[abcd] W[ecfi] p[afgh] E2[dgbh] delta[ie] 
    {"abcd,ecfi,agfh,dgbh,ie",    -2.0,   5, { 6,15, 5,20,18}},  //  -2.0 Ap[abcd] W[ecfi] p[agfh] E2[dgbh] delta[ie] 
    {"abcd,efga,ebch,dfhg",        1.0,   4, { 6,15, 5,20}},     //   1.0 Ap[abcd] W[efga] p[ebch] E2[dfhg] 
    {"abcd,efga,ebgh,dfhc",       -2.0,   4, { 6,15, 5,20}},     //  -2.0 Ap[abcd] W[efga] p[ebgh] E2[dfhc] 
    {"abcd,efga,ecbh,dfgh",        1.0,   4, { 6,15, 5,20}},     //   1.0 Ap[abcd] W[efga] p[ecbh] E2[dfgh] 
    {"abcd,efga,ecgh,dfbh",       -2.0,   4, { 6,15, 5,20}},     //  -2.0 Ap[abcd] W[efga] p[ecgh] E2[dfbh] 
    {"abcd,efga,egbh,dfhc",        1.0,   4, { 6,15, 5,20}},     //   1.0 Ap[abcd] W[efga] p[egbh] E2[dfhc] 
    {"abcd,efga,egch,dfbh",        1.0,   4, { 6,15, 5,20}},     //   1.0 Ap[abcd] W[efga] p[egch] E2[dfbh] 
    {"abcd,efgi,abgh,dfhc,ie",     1.0,   5, { 6,15, 5,20,18}},  //   1.0 Ap[abcd] W[efgi] p[abgh] E2[dfhc] delta[ie] 
    {"abcd,efgi,abhf,dhgc,ie",    -1.0,   5, { 6,15, 5,20,18}},  //  -1.0 Ap[abcd] W[efgi] p[abhf] E2[dhgc] delta[ie] 
    {"abcd,efgi,acgh,dfbh,ie",     1.0,   5, { 6,15, 5,20,18}},  //   1.0 Ap[abcd] W[efgi] p[acgh] E2[dfbh] delta[ie] 
    {"abcd,efgi,achf,dhbg,ie",    -1.0,   5, { 6,15, 5,20,18}},  //  -1.0 Ap[abcd] W[efgi] p[achf] E2[dhbg] delta[ie] 
    {"abcd,efgi,agbh,dfch,ie",     1.0,   5, { 6,15, 5,20,18}},  //   1.0 Ap[abcd] W[efgi] p[agbh] E2[dfch] delta[ie] 
    {"abcd,efgi,agch,dfbh,ie",    -2.0,   5, { 6,15, 5,20,18}},  //  -2.0 Ap[abcd] W[efgi] p[agch] E2[dfbh] delta[ie] 
    {"abcd,efgi,ahbf,dhcg,ie",    -1.0,   5, { 6,15, 5,20,18}},  //  -1.0 Ap[abcd] W[efgi] p[ahbf] E2[dhcg] delta[ie] 
    {"abcd,efgi,ahcf,dhbg,ie",     2.0,   5, { 6,15, 5,20,18}},  //   2.0 Ap[abcd] W[efgi] p[ahcf] E2[dhbg] delta[ie] 
    {"abcd,ef,aegh,dfgbhc",       -1.0,   4, { 6,10, 5,22}},     //  -1.0 Ap[abcd] k[ef] p[aegh] E3[dfgbhc] 
    {"abcd,ef,ageh,dfgbch",       -1.0,   4, { 6,10, 5,22}},     //  -1.0 Ap[abcd] k[ef] p[ageh] E3[dfgbch] 
    {"abcd,ef,aghe,dghbfc",        1.0,   4, { 6,10, 5,22}},     //   1.0 Ap[abcd] k[ef] p[aghe] E3[dghbfc] 
    {"abcd,ae,efgh,dfgbhc",        1.0,   4, { 6,11, 5,22}},     //   1.0 Ap[abcd] k[ae] p[efgh] E3[dfgbhc] 
    ...
    {"abcd,aejf,fghi,dghbic,je",  -1.0,   5, { 6,13, 5,22,18}},  //  -1.0 Ap[abcd] W[aejf] p[fghi] E3[dghbic] delta[je] 
    {"abcd,aefj,fghi,dghbic,je",   2.0,   5, { 6,13, 5,22,18}},  //   2.0 Ap[abcd] W[aefj] p[fghi] E3[dghbic] delta[je] 
    ...
    {"abcd,ebfa,eghi,dghcif",      1.0,   4, { 6,15, 5,22}},     //   1.0 Ap[abcd] W[ebfa] p[eghi] E3[dghcif] 
    {"abcd,ecfa,eghi,dghbif",     -2.0,   4, { 6,15, 5,22}},     //  -2.0 Ap[abcd] W[ecfa] p[eghi] E3[dghbif] 
    {"abcd,efga,ebhi,dfhicg",      1.0,   4, { 6,15, 5,22}},     //   1.0 Ap[abcd] W[efga] p[ebhi] E3[dfhicg] 
    {"abcd,efga,echi,dfhbig",      1.0,   4, { 6,15, 5,22}},     //   1.0 Ap[abcd] W[efga] p[echi] E3[dfhbig] 
    {"abcd,efga,eghi,dfhbci",      1.0,   4, { 6,15, 5,22}},     //   1.0 Ap[abcd] W[efga] p[eghi] E3[dfhbci] 
    {"abcd,efga,ehbi,dfhgci",      1.0,   4, { 6,15, 5,22}},     //   1.0 Ap[abcd] W[efga] p[ehbi] E3[dfhgci] 
    {"abcd,efga,ehci,dfhbgi",      1.0,   4, { 6,15, 5,22}},     //   1.0 Ap[abcd] W[efga] p[ehci] E3[dfhbgi] 
    {"abcd,efga,ehgi,dfhbci",     -2.0,   4, { 6,15, 5,22}},     //  -2.0 Ap[abcd] W[efga] p[ehgi] E3[dfhbci] 
    {"abcd,efgj,aghi,dfhbic,je",   1.0,   5, { 6,15, 5,22,18}},  //   1.0 Ap[abcd] W[efgj] p[aghi] E3[dfhbic] delta[je] 
    {"abcd,efgj,ahgi,dfhbci,je",   1.0,   5, { 6,15, 5,22,18}},  //   1.0 Ap[abcd] W[efgj] p[ahgi] E3[dfhbci] delta[je] 
    {"abcd,efgj,ahif,dhibgc,je",  -1.0,   5, { 6,15, 5,22,18}},  //  -1.0 Ap[abcd] W[efgj] p[ahif] E3[dhibgc] delta[je] 
    ...
    {"abcd,efga,ehij,dfhibcjg",    1.0,   4, { 6,15, 5,23}},     //   1.0 Ap[abcd] W[efga] p[ehij] E4[dfhibcjg] 
	};

  FEqInfo bVec[7] = {
    {"ABCE,ABCD,ED"    ,   2.0,   3, { 3,16,19}}, //  2.0 b[abce] V[abcd] E1[ed]
    {"ACBE,ABCD,ED"    ,  -1.0,   3, { 3,16,19}}, // -1.0 b[acbe] V[abcd] E1[ed]
    {"ABEF,ABCD,CFED"  ,  -1.0,   3, { 3,16,20}}, // -1.0 b[abef] V[abcd] E2[cfed]
    {"ACEF,ABCD,BFDE"  ,  -1.0,   3, { 3,16,20}}, // -1.0 b[acef] V[abcd] E2[bfde]
    {"AEBF,ABCD,CFDE"  ,  -1.0,   3, { 3,16,20}}, // -1.0 b[aebf] V[abcd] E2[cfde]
    {"AECF,ABCD,BFDE"  ,   2.0,   3, { 3,16,20}}, //  2.0 b[aecf] V[abcd] E2[bfde]
    {"AEFG,ABCD,BCGDFE",  -1.0,   3, { 3,16,22}}, // -1.0 b[aefg] V[abcd] E3[bcgdfe]
  };
