...
pvec  = sqa.tensor('p',  [a,p,q,r], [])
Apvec = sqa.tensor('Ap', [b,u,v,w], [])
Omu   = sqa.term( 1.0, [''],  [pvec,  sqa.sfExOp([a, q]) , sqa.sfExOp([p, r])])
Onu   = sqa.term( 1.0, [''],  [Apvec, sqa.sfExOp([w, u]) , sqa.sfExOp([v, b])])
commutator = []
...
Class = 'AAAV'
tensors  = make_tensors('eaaa',pttype='MRLCC')
tensors.append(['S1','S1','aaaaaa','D'])
