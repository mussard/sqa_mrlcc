...
pvec  = sqa.tensor('p',  [i,j,p,a], [])
Apvec = sqa.tensor('Ap', [k,l,q,b], [])
Omu   = sqa.term( 1.0, [''],  [pvec,  sqa.sfExOp([p, i]) , sqa.sfExOp([a, j])])
Onu   = sqa.term( 1.0, [''],  [Apvec, sqa.sfExOp([l, b]) , sqa.sfExOp([k, q])])
commutator = []
...
Class = 'CCAV'
tensors  = make_tensors('ccae',pttype='MRLCC')
